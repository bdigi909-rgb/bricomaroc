...
// ============================================================
// ARTISANS SECTION (Server Component)
// ============================================================
...
function Testimonials() {
  const temoignages = [
    {
      note: 5, text: 'Youssef est arrivé en 45 minutes, a réparé la fuite proprement. Prix honnête. Je recommande vivement BricoMaroc !',
      auteur: 'Fatima M.', ville: 'Guéliz, Marrakech', date: 'il y a 3 jours'
    },
    {
      note: 5, text: 'Khalid a installé mon tableau électrique en une journée. Très professionnel, explique bien ce qu\'il fait.',
      auteur: 'Karim R.', ville: 'Hivernage, Marrakech', date: 'il y a 1 semaine'
    },
    {
      note: 4, text: 'Bon service dans l\'ensemble. Léger retard mais résultat nickel. La plateforme est très simple à utiliser.',
      auteur: 'Sara L.', ville: 'Médina, Marrakech', date: 'il y a 2 semaines'
    },
  ]
        ...
        <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-orange-100 text-base leading-relaxed max-w-lg">
              Inscription gratuite. Recevez des demandes de clients vérifiés directement sur votre téléphone. Commencez à gagner dès aujourd'hui.
            </p>
...
function Footer() {
  return (
    <footer className="bg-white border-t border-[var(--color-border)] py-10">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          {[
            { title: 'Clients', links: ['Trouver un artisan', 'Publier une demande', 'Comment ça marche', 'Mes demandes'] },
            { title: 'Artisans', links: ['Devenir artisan', 'Tarifs & Plans', 'Espace artisan', 'Aide'] },
            { title: 'BricoMaroc', links: ['À propos', 'Blog', 'Contact', 'CGU'] },
          ].map(col => (
            <div key={col.title}>
